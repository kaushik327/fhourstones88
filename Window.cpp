...
Window::Window(const char *bookfile)
    : game(), search(this, game, bookfile), nmoves(0) {}
...
bool Window::solve() {
  ...
  printf("  %ju pos / %ju msec = %jd Kpos/sec\n", (uintmax_t)search.nodes,
         (uintmax_t)search.msecs, (intmax_t)(search.nodes / search.msecs));
  return true;
}

bool Window::evals() { return true; }

bool Window::stats() { return true; }
bool Window::chglvl(int) { return true; }
